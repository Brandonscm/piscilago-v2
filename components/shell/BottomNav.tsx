...
import { Home, Map, Clock, Trophy, User } from "lucide-react";

const TABS = [
  { href: "/home", label: "Inicio", icon: Home },
  { href: "/mapa", label: "Mapa", icon: Map },
  { href: "/filas", label: "Filas", icon: Clock },
  { href: "/recompensas", label: "Premios", icon: Trophy },
  { href: "/pulsera", label: "Pulsera", icon: User },
];
...
export function BottomNav() {
  ...
  return (
    <nav className="bg-white border-t border-ink-100 grid grid-cols-5 items-start px-2 pt-2 pb-4 md:pb-3 shrink-0 safe-bottom">
